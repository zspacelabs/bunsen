...
mod value_cache {
    ...
    mod tests {
        ...
        fn test_cached_value_set_and_clear() {
            ...
            // The setter populates the slot on its own, with no read in
            // between.
        ...
        fn test_cached_value_types_do_not_collide() {
            ...
            // A second type holds an independent slot. Were the two to share
            // one, this would fail the downcast rather than the
            // assertion.
