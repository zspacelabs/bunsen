...
pub mod encoder {
    ...
    /// The generated weights, as emitted beside the model source.
    pub const WEIGHTS: &[u8] =
        include_bytes!(concat!(env!("OUT_DIR"), "/whisper_base_encoder.bpk"));

    impl<B: Backend> Model<B> {
        /// Loads the reference encoder.
